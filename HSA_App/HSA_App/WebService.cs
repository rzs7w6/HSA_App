...
namespace HSA_App
{
	public class WebService
	{
		...
		public async Task<List<Transaction>> GetTransactions(Int64 accountNumber)
		{
			...
			try
			{
				var response = await client.PutAsync(client.BaseAddress+accountNumber.ToString(),null);
		...
		public async Task<int> GenerateBalance(Balance balance)
		{
			...
			{
				StringContent content = new StringContent(json, UnicodeEncoding.UTF8, "application/json");
				var response = await client.PostAsync("http://ec2-54-69-2-41.us-west-2.compute.amazonaws.com/rest2/api/balance", content);
			}
			catch (Exception ex)
			{
				Debug.WriteLine(ex);
		...
		public async Task<int> DepositTransaction(Transaction transaction)
		{
			...
			{
				StringContent content = new StringContent(json, UnicodeEncoding.UTF8, "application/json");
				var response = await client.PostAsync("http://ec2-54-69-2-41.us-west-2.compute.amazonaws.com/rest2/api/transaction", content);
			}
			catch (Exception ex)
			{
				Debug.WriteLine(ex);
		...
		public async Task<double> GetDepoData(Int64 accountNum)
		{
			...
			try
			{
				var response = await client.GetAsync("http://ec2-54-69-2-41.us-west-2.compute.amazonaws.com/rest2/api/transaction/" + accountNum.ToString());
